...
namespace DS4Input
{
    ...
    public class DS4Input : SingletonMonoBehaviour<DS4Input>
    {
        [DllImport("DS4Input")]
        ...
        /// <returns></returns>
        public static bool IsButton(DS4ControllerType id, DS4ButtonType keyType)
        {
        ...
        /// <param name="keyType">ボタンのタイプ</param>
        /// <returns></returns>
        public static bool IsButtonDown(DS4ControllerType id, DS4ButtonType keyType)
        {
        ...
        /// <param name="keyType">ボタンのタイプ</param>
        /// <returns></returns>
        public static bool IsButtonUp(DS4ControllerType id, DS4ButtonType keyType)
        {
        ...
        /// <returns></returns>
        public static float IsAxis(DS4ControllerType id, DS4AxisType axisType)
        {
        ...
        public static void SetVibration(DS4ControllerType id, DS4Vibration vibration)
        {
        ...
        public static void SetColor(DS4ControllerType id, DS4Color color)
        {
        ...
        /// <param name="color">変化後の色</param>
        /// <param name="vibration">振動値</param>
        public static void SetColorAndVibration(DS4ControllerType id, DS4Color color, DS4Vibration vibration)
        {
            ChangeColor((int)id, color.red, color.green, color.blue);
            ChangeVibration((int)id, vibration.right, vibration.left);
            SendOutput((int)id);
